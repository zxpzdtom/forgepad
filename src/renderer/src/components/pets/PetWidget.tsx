...
export function PetWidget() {
  ...
  const completionCards = useAppStore((s) => s.completionCards);
  ...
  // ── Completion card handlers ──
  const handleCompletionDismiss = useCallback(() => {
    if (currentCompletionCard) {
  ...
  return (
    ...
    >
      ...
      {/* Completion card positioned above the pet (lower priority than approval) */}
