...
export const PET_REGISTRY: PetDefinition[] = [
  { id: 'aerith', displayName: 'Aerith', description: 'A gentle Codex digital pet inspired by a flower mage heroine, with brown braided hair, a pink dress, a red cropped jacket, green eyes, and one tiny flower.', spritesheetPath: 'spritesheet.webp', kind: 'object' },
  { id: 'akane', displayName: 'Akane', description: 'A tiny tsundere maid with red twin tails who fusses over unfinished work while pretending not to care.', spritesheetPath: 'spritesheet.webp' },
  { id: 'amane', displayName: 'Amane', description: 'A compact Codex digital pet version of Amane.', spritesheetPath: 'spritesheet.webp' },
  { id: 'anya', displayName: 'Anya', description: 'A tiny Anya Forger inspired telepath girl mascot from Spy x Family, made as a Codex digital pet with rich cute expressions and lively actions.', spritesheetPath: 'spritesheet.webp' },
  { id: 'apupepe', displayName: 'Pepe', description: 'A compact Codex-style green frog pet in a plain blue shirt.', spritesheetPath: 'spritesheet.webp' },
  ...
  { id: 'chopper', displayName: 'Chopper', description: 'A tiny Codex pet version of Tony Tony Chopper with a blue cap, pink brim, antlers, round eyes, striped vest, and orange shorts.', spritesheetPath: 'spritesheet.webp' },
  ...
  { id: 'daodun', displayName: 'DaoDun', description: 'A compact pixel-art meme warrior pet with a round dog-like body, a smug grin, a short sword, and a raised wooden shield.', spritesheetPath: 'spritesheet.webp' },
  ...
  { id: 'duo', displayName: 'Duo', description: 'Learning companion with expressive chibi sprite poses.', spritesheetPath: 'spritesheet.webp' },
  ...
  { id: 'graycraft4', displayName: 'STORM // GRAYCRAFT4', description: 'A meacing but loyal red-and-black mech companion from the GRAYCRAFT series, built to move with precision and stand by you through the work. Learn more at GRAYCRAFT.com.', spritesheetPath: 'spritesheet.webp' },
  ...
  { id: 'hutao', displayName: '胡桃', description: '胡桃是《原神》中的五星火元素角色，使用长柄武器，是璃月「往生堂」第七十七代堂主。她性格古灵精怪、活泼俏皮，喜欢作诗和恶作剧，但对生死有着成熟豁达的理解。外形以黑红服饰、礼帽和梅花装饰为特色，神秘又可爱。', spritesheetPath: 'spritesheet.webp', kind: 'person' },
  ...
  { id: 'kaguya', displayName: 'Kaguya', description: 'A tiny chibi Cosmic Princess Kaguya companion with moon-rabbit details and bright festival robes.', spritesheetPath: 'spritesheet.webp', kind: 'person' },
  ...
  { id: 'labubu-classic', displayName: 'Labubu Classic', description: 'La bu bu, labu labu, la bubu ~', spritesheetPath: 'spritesheet.webp' },
  ...
  { id: 'nezuko', displayName: 'Nezuko', description: 'A cute Codex digital pet inspired by Nezuko Kamado.', spritesheetPath: 'spritesheet.webp' },
  { id: 'nezukocoder', displayName: 'NezukoCoder', description: 'A chibi Nezuko-inspired coding companion typing on a laptop with a simple OpenAI emblem.', spritesheetPath: 'spritesheet.webp' },
  { id: 'nika', displayName: 'Nika', description: 'A chibi rubber pirate pet with straw hat energy, Gear Five white-hair poses, and a comically full meat-belly reaction.', spritesheetPath: 'spritesheet.webp' },
  ...
  { id: 'phrat', displayName: 'PHRAT', description: 'A tiny angelic demon schoolgirl digital pet with pink twin-tails, black bows, a gold broken halo, sharp grin, white shirt, black vest, red tie, and backpack.', spritesheetPath: 'spritesheet.webp' },
  ...
  { id: 'rx-78-2-gundam', displayName: 'RX-78-2 Gundam', description: 'A compact Codex pet version of the classic white, blue, red, and yellow RX-78-2 style mecha with V-fin helmet, yellow eyes, shoulder cannons, red feet, and a handheld beam rifle.', spritesheetPath: 'spritesheet.webp' },
  ...
  { id: 'snoopy', displayName: 'Snoopy', description: 'A tiny black-and-white beagle with a red collar for calm coding sessions.', spritesheetPath: 'spritesheet.webp' },
  { id: 'steve', displayName: 'Steve', description: 'Minecraft风格Steve形象的像素风Codex宠物，方块头，棕发，浅棕肤色，青蓝上衣，深蓝裤子，灰色鞋子。', spritesheetPath: 'spritesheet.webp' },
  { id: 'steve-jobs', displayName: 'Steve Jobs', description: 'A tiny pixel-art Steve Jobs companion in a black turtleneck, jeans, glasses, and sneakers.', spritesheetPath: 'spritesheet.webp' },
  ...
  { id: 'takagi', displayName: '高木同学', description: 'A custom Codex pet inspired by Takagi, with long chestnut hair, a red winter coat, and a cream-and-tan plush cat.', spritesheetPath: 'spritesheet.webp' },
  { id: 'takagi-san', displayName: '高木', description: '带有高木同学标志性捉弄感咧嘴笑的 Q 版桌宠。', spritesheetPath: 'spritesheet.webp' },
  ...
  { id: 'totoro', displayName: 'Totoro', description: 'A pointy-eared chinchilla digital pet inspired by the reference.', spritesheetPath: 'spritesheet.webp' },
  ...
  { id: 'vault-boy', displayName: 'Vault Boy', description: 'A cheerful retro vault mascot pet with blond hair, a blue jumpsuit, yellow trim, and task-specific thumbs-up and wrist-computer poses.', spritesheetPath: 'spritesheet.webp' },
  { id: 'xiao-zhu', displayName: '小渚', description: 'A cute, gentle Codex digital pet inspired by a school-uniform anime heroine reference.', spritesheetPath: 'spritesheet.webp' },
  { id: 'xiaoxilian', displayName: '小昔涟', description: '翁法罗斯里的记忆的孩子。', spritesheetPath: 'spritesheet.webp', kind: 'person' },
  ...
  { id: 'zoro', displayName: 'Zoro', description: 'A tiny chibi three-sword pirate swordsman pet with green hair, one closed scarred left eye, a handle-bitten mouth sword, and one purple left-hand sword.', spritesheetPath: 'spritesheet.webp' },
];
