  ...
  if (!bundle) {
    return (
      <section className="absolute inset-0 flex min-h-0 min-w-0 items-center justify-center gap-3 bg-bg p-[30px] text-center">
        ...
        <h1 className="m-0 text-[22px] font-[590]">No context bundle yet</h1>
        <p className="m-0 max-w-[460px] leading-[1.55] text-muted">
          Use the Context panel to send selected files, diffs, and comments to
          the terminal.
        </p>
      </section>
    );
