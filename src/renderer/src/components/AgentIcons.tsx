...
export function WindsurfIcon({ size = 16, className }: IconProps) {
  return (
    ...
    >
      ...
      <path
        d="M6 7c3 0 5 2.5 6 5-1-1.5-3-2.5-6-2.5V7zm0 5c3 0 5 2.5 6 5-1-1.5-3-2.5-6-2.5V12z"
        fill="#fff"
      />
    </svg>
  );
  ...
  return (
    ...
    >
      ...
      <path
        fill="#0EE827"
        fillOpacity=".35"
        d="M367.404 226.769h89.135v178.269h-89.135z"
      />
      <path
...
export function IntelliJIcon({ size = 16, className }: IconProps) {
  return (
    ...
    >
      ...
      <path
        fill="url(#ij-c)"
        d="M99.1 221.3l-78.5 28.4 16.5-57.5 21.2-71.3L0 101.4 37.1 0l83.8 9.9 86.3 105.9z"
      />
